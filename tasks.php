...
<head>
  ...
  let php_date = "<?php if(isset($selectedDate)){echo $selectedDate;}?>";
...
?>
  ...
  <ul>
    <li>Drucksachen</li>
    <a href="#" onclick="printPDF('../plans/DayTodoPlanII.pdf')"><li>> Pomodoro DayPlan</li></a>
    <a href="#" onclick="printPDF('../plans/WochenToDo.pdf')"><li>> Wochenstatistik</li></a>
    <a href="#" onclick="printPDF('../plans/Wochenplan2.pdf')"><li>> Stundenplan</li></a>
    <a href="#" onclick="printPDF('../plans/dayTodoWeekPlan2Printable.pdf')"><li>> Tages Todo Faltware</li></a>
  </ul>
  <hr>
  <ul>
  ...
  <hr>
  <ul>
    <a href="?yesterday"><li>Gestern</li></a>
    <a href="?today"><li>Heutige Aufgaben</li></a>
    <a href="?tomorrow"><li>Morgen</li></a>
  </ul>
  <hr>
  <ul>
    <a href="?search"><li>Search <i class="fas fa-search small"></i></li></a>
    <a href="?bahnapi"><li>BahnAPI</li></a>
    <a href="?settings"><li>Settings</li></a>
    <a href="?youtube"><li>Youtube History</li></a>
  </ul>
</div>
<main>
